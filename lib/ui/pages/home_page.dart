    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          const Spacer(),
          Text('MGL', style: Theme.of(context).textTheme.titleLarge?.copyWith(fontSize: 28, letterSpacing: 2)),
          const Spacer(),
          IconButton(
            onPressed: () => _showNotifications(context),
            icon: Icon(Icons.notifications_rounded, color: Theme.of(context).textTheme.bodyMedium?.color),
          ),
        ],
      ),
    );
  ...
  Widget _buildNavItem(IconData icon, String label, int index) {
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isSelected ? Theme.of(context).colorScheme.primary.withAlpha(25) : Colors.transparent,
          borderRadius: BorderRadius.circular(12),
        ),
        child: Column(
