...
class ProfilePageState extends State<ProfilePage> with SingleTickerProviderStateMixin {
        ...
        SliverPadding(
          ...
          sliver: SliverList(
            delegate: SliverChildListDelegate([
              ...
              _buildProfileCard(context, 'Avg Rating', gameManager.averageRating.toStringAsFixed(1), Icons.star_rounded, () => _showRatingBreakdown(context, gameManager.averageRating)),
              _buildProfileCard(context, 'Platforms', '5', Icons.devices_rounded, () => _showPlatforms(context)),
              _buildProfileCard(context, 'Favorites', gameManager.favoriteCount.toString(), Icons.favorite_rounded, () => _navigateToMyList('Favorites')),
              const SizedBox(height: 20),
            ]),
          ),
        ),
  ...
  Widget _buildProfileCard(BuildContext context, String title, String value, IconData icon, VoidCallback onTap) {
