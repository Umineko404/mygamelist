            ...
            itemBuilder: (context, index) {
              ...
              return Container(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(discussion['title'], style: Theme.of(context).textTheme.titleMedium),
                    const SizedBox(height: 12),
                    Row(
                      children: [
                        Text('by ${discussion['author']}', style: Theme.of(context).textTheme.bodyMedium?.copyWith(fontSize: 13)),
                        const Spacer(),
                        Container(
                    ...
                    Row(
                      children: [
                        Icon(Icons.reply, size: 16, color: Theme.of(context).textTheme.bodyMedium?.color),
                        const SizedBox(width: 4),
                        Text('${discussion['replies']} replies', style: Theme.of(context).textTheme.bodyMedium),
                        const Spacer(),
                        Text('Last reply: ${discussion['lastReply']}', style: Theme.of(context).textTheme.bodyMedium?.copyWith(fontSize: 13)),
                      ],
                    ),
                  ],
                ),
